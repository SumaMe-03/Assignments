...
title('BPSK Modulation and Demodulation Performance with Increased Bit Rate', 'Fontsize' ,22);

xlabel('Sample Number', 'Fontsize' ,22);
ylabel('Bit Value', 'Fontsize' ,22);

legend('Original Data', 'Demodulated Data', 'Location', 'northeast');
set(legend, 'BoxFaceColor', [1 1 1]);  % Set legend background to white

grid on;
ylim([-1.5 1.5]);  %to clearly show bit values
