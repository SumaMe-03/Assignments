...
q=input("Enter the matrix p(y/x): "); %matrix P(y|x) disp(q);
disp(''); N=1:n;
px=input("Enter the probability: "); %probabilities for X px=diag(p,n,n); %matrix P(X)
disp("P(x) : ");
disp(px);
disp('');
